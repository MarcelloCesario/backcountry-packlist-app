    ...
    <div className="card hover:shadow-md transition-shadow">
      <div className="flex justify-between items-start">
        <div className="flex-1">
          <h3 className="font-medium text-mountain-900">{item.name}</h3>
          ...
          <div className="mt-2 text-sm text-mountain-600">
            <span className="font-medium">{formatWeight(item.weight)}</span>
          </div>
          {item.notes && (
            <p className="mt-2 text-sm text-mountain-500">{item.notes}</p>
          )}
        </div>
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${
                item.in_wishlist
                  ...
                  : 'text-mountain-400 hover:bg-mountain-100'
              }`}
